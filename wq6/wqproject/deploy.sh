...
cd ../;
sed -i "s/wqproject.js/wqproject.js?v="$1"/" htdocs-build/wqproject.appcache
sed -i "s/wqproject.css/wqproject.css?v="$1"/" htdocs-build/wqproject.appcache
